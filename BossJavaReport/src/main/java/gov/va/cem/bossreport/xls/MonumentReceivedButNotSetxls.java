 ...
 * http://localhost:8888/bossreport/monrecvnotsetxls?u=62574dd8f22ae9c0eb4330229da7bf6459837255183e214f&cem_num=901&start_dt=01/01/2006&end_dt=01/01/2007
 * 
 */
 
public class MonumentReceivedButNotSetxls extends HttpServlet 
{
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
        ...
        if (!(Utility.setRole(conn, "nca_sic"))) {
            ...
            try
            {
              ...
              res.setHeader("Content-Disposition","attachment; filename=MonRecNotSet_cem" + cemNum + ".xls");   // filename
              ServletOutputStream out= res.getOutputStream();

              //header in Excel
              out.println ("Monuments Received But Not Set Report \n " +
                           cemNum + " " + cemNme + "\n");
