 ...
 * http://localhost:8888/bossreport/monrecvnotsetbytypexls?u=62574dd8f22ae9c0eb4330229da7bf6459837255183e214f&cem_num=901&start_dt=01/01/2006&end_dt=01/01/2007
 * 
 */
 
public class MonumentReceivedButNotSetByTypexls extends HttpServlet 
{
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
        ...
        if (!(Utility.setRole(conn, "nca_sic"))) {
            ...
            try
            {
              ...
              res.setHeader("Content-Disposition","attachment; filename=MonRecNotSetByType_cem" + cemNum + ".xls");   // filename
              ServletOutputStream out= res.getOutputStream();

              //header in Excel
              out.println ("Monuments Received But Not Set By Type Report \n " +
                           cemNum + " " + cemNme + "\n");
              out.println("INTER DT\t" + "DEC ID\t" + 
                            "FIRST NAME\t" + "LAST NAME\t" +
                            "TC\t" + "CEM\t" + "SEC ID\t" + "ROW NUM\t" + "SITE NUM\t" +
                            "SHIP FY\t" + "SHIP PRE\t" + "CBL\t" + "ORDER DT\t" + "RECEIVED DT" 
                         );
              ...
              {  
                 ...
                 out.println(Utility.blankIfNull(decInfo[0]) + "\t" + //interment_dt
                             ...
                             Utility.blankIfNull(rs.getString(3)) + "\t" + //order_dt
                             Utility.blankIfNull(rs.getString(4)) //receuved_dt
                            );
              }
