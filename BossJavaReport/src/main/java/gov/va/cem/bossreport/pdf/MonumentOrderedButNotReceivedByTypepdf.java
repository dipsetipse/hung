 ...
 * http://localhost:8888/bossreport/monordernotrecvbytypexls?u=c46a1ca72d8c332e8196a736fbb3d7164277a2b9a1525386
   to make it fail (wrong password for n911frm), try this:
      http://localhost:8888/bossreport/monordernotrecvbytypexls?u=fb9fb36d58e31f91d5a3c92d2c4b9e1914dc1363e3aa5925
      SQL:
...
public class MonumentOrderedButNotReceivedByTypepdf extends HttpServlet 
{
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
        ...
        try { //1 PDF
            ...
            doc.addTitle("Monuments Ordered But Not Received By Type");  //change this to your report name
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("MONUMENTS ORDERED BUT NOT RECEIVED BY TYPE\n" +
                                                   cemNUM + " " + cemNME + "\n",
       ...
       */
            ...
            arrayColWid[4] = 2; //monument_type_cd
            ...
            arrayColWid[12] = 11; //release_dt
            arrayColWid[13] = 11; //order_dt
            ...
            cell = new PdfPCell(new Phrase("RELEASE DT", boldFont));
            cell.setHorizontalAlignment(1);
            tbl.addCell(cell);
        ...
        */
            ...
            try {
                ...
                while (rs.next()) 
                {
                   ...
                   cell = new PdfPCell(new Phrase(Utility.blankIfNull(rs.getString(3)), font));//release_dt
                   cell.setHorizontalAlignment(1);
                   if (grey) {
                      cell.setBackgroundColor(Color.LIGHT_GRAY);
                   }
                   ...
                   cell = new PdfPCell(new Phrase(Utility.blankIfNull(rs.getString(4)), font));//order_dt
                   cell.setHorizontalAlignment(1);
                   if (grey) {
                      cell.setBackgroundColor(Color.LIGHT_GRAY);
                   }
