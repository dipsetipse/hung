 ...
 * http://localhost:8888/bossreport/monrecvnotsetpdf?u=c46a1ca72d8c332e8196a736fbb3d7164277a2b9a1525386
   to make it fail (wrong password for n911frm), try this:
      http://localhost:8888/bossreport/monrecvnotsetpdf?u=fb9fb36d58e31f91d5a3c92d2c4b9e1914dc1363e3aa5925
      SQL:
...
public class MonumentReceivedButNotSetpdf extends HttpServlet 
{
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
        ...
        try { //1 PDF
            ...
            doc.addTitle("Monuments Received But Not Set");  //change this to your report name
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("MONUMENTS RECEIVED BUT NOT SET\n" +
                                                   cemNum + " " + cemNme + "\n",
