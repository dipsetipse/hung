 ...
 * http://localhost:8888/bossreport/monordernotrecvpdf?u=c46a1ca72d8c332e8196a736fbb3d7164277a2b9a1525386
   to make it fail (wrong password for n911frm), try this:
      http://localhost:8888/bossreport/monordernotrecvpdf?u=fb9fb36d58e31f91d5a3c92d2c4b9e1914dc1363e3aa5925
      SQL:
...
public class MonumentOrderedButNotReceivedpdf extends HttpServlet 
{
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
        ...
        try { //1 PDF
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("MONUMENTS ORDERED BUT NOT RECEIVED\n" +
                                                   cemNUM + " " + cemNME + "\n",
       ...
       */
            ...
            tbl.setHeaderRows(1); //end the header that will repeat on every page
                   ...
                   qry = "select id, " +
                         ...
                         "order by monument_type_cd, amas_order_dt";
