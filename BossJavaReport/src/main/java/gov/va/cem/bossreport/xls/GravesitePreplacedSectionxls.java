 ...
 * @author cemNguyeH
 */
public class GravesitePreplacedSectionxls extends HttpServlet 
{
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
        ...
        String qry = "select 'ALL DISTRICTS' from dual ";
            ...
            qry = "select g.cemetery_num, " +
                  ...
                  "  g.district_id = d.id " +
                  "order by g.district_id, g.cemetery_num, g.last_update_dt";
        ...
        try {
                ...
                res.setHeader("Content-Disposition","attachment; filename=GPS_ALL" + " " + startDT + ".xls");   // filename
