 ...
 * http://localhost:8888/bossreport/monordernotrecvxls?u=62574dd8f22ae9c0eb4330229da7bf6459837255183e214f&cem_num=901&start_dt=01/01/2006&end_dt=01/01/2007
 * 
 */
 
public class MonumentOrderedButNotReceivedxls extends HttpServlet 
{
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
        ...
        if (!(Utility.setRole(conn, "nca_sic"))) {
            ...
            try
            {
              ...
              res.setHeader("Content-Disposition","attachment; filename=MonOrderNotrRec_cem" + cemNum + ".xls");   // filename
              ServletOutputStream out= res.getOutputStream();

              //header in Excel
              out.println ("Monuments Ordered But Not Received Report \n " +
                           cemNum + " " + cemNme + "\n");
              ...
              {  
                 ...
                 out.println(Utility.blankIfNull(decInfo[0]) + "\t" + //inter_dt
